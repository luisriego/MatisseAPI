...
final class LedgerCreditedEvent implements DomainEventInterface
{
    ...
    private string $description; // Added description as per subtask description
    ...
    public static function fromPayload(
        ...
        if (!isset($payload['amount'], $payload['currency'], $payload['transactionId'], $payload['description'])) {
            throw new InvalidArgumentException('Payload for LedgerCreditedEvent is missing required fields.');
        }
        return new self(
            $eventId,
